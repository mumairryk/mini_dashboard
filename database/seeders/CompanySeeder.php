...
class CompanySeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $sysUser = User::firstWhere('email', "admin@admin.com");
        ...
        Company::factory()->count(30)->create()->each(function($company) use($statuses, $password, $sysUser){
            ...
            $role_company_admin = Role::firstWhere('name', 'company');
            ...
            $role_hr = Role::firstWhere('name', 'hr');
            ...
            $role_hra = Role::firstWhere('name', 'assistant');
